...
def main(args):
    ...
    for epoch in range(args.epochs):
        ...
        #    break
        if args.early_stop and early_stopper.early_stop(1.0-mean_iou):
            print("Training halted early due to reaching patience limit.")
            break
    if args.wb:
        run.finish()
...
def parse_args():
    ...
    parser.add_argument("--input_size", type=int, default=1754, help="model input size, H = W")
    ...
    parser.add_argument("--early-stop-delta", type=float, default=0.005, help="Minimum Delta for early stopping")
