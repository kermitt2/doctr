...
def _fast_grey(
    ...
    **kwargs: Any,
    ...
    # force non pretrained model/backbone
    pretrained = False
    ...
    if not kwargs.get("class_names", None):
        ...
        kwargs["class_names"] = sorted(kwargs["class_names"])
    # Build the model
    model = FAST(feat_extractor, cfg=default_cfgs[arch], grey=True, **kwargs)
...
def fast_grey(pretrained: bool = False, **kwargs: Any) -> FAST:
    """
